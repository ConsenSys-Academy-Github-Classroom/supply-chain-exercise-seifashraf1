...
contract SupplyChain {
    ...
    // <items mapping>
    mapping(uint256 => Item) public items; // maps item by its ID
    ...
    //I should add modifiers to check for sold items, make sure that seller is the only one calling the funcion
    // I changed the state of each item to be shipped
